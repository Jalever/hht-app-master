<template>
  <div class="app">
    <van-tabs @click="tabClick">
      <van-tab v-for="item in data" :key="item.name" :title="item.name">
        <div class="list-content">
          <p class="list-content-title" @click="EbbinghausClick">
            艾宾浩斯曲线学习计划<img
              src="../assets/image/course/icon_tips@2x.png"
              alt=""
            />
          </p>
          <div class="list-box">
            <ul v-for="titleItem in tabData.classHours" :key="titleItem.index">
