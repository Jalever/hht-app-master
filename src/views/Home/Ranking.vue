<template>
  <div class="app">
      ...
      <ul>
        <li v-for="(item, index) in topList" :key="index" v-if="item.score > 0">
          <div class="list-index">
            <p v-if="index == 0">
              <img src="../../assets/image/home_rank_icon1st@3x.png" />
            </p>
            <p v-else-if="index == 1">
              <img src="../../assets/image/home_rank_icon2nd@3x.png" />
            </p>
            <p v-else-if="index == 2">
              <img src="../../assets/image/home_rank_icon3rd@3x.png" />
            </p>
            <p v-else>{{ index + 1 }}</p>
          </div>
          <div class="list-img">
    ...
    <div
      class="user-list"
      v-if="userid != null && userid == userBaby.id && userList.length != 0"
    >
        ...
        <ul>
          <li>
            ...
            <div class="list-img">
              ...
              <img
                v-else-if="userList.sex == '男'"
                src="../../assets/image/my_avatar_boy@3x.png"
                alt=""
              />
              <img
                v-else
                src="../../assets/image/my_avatar_girl@3x.png"
                alt=""
              />
            </div>
            <div class="lsit-name">
