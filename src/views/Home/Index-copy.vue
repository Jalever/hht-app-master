    ...
    <div class="content" v-show="isLoading">
        ...
        <div class="member-user-bg">
          ...
          <div class="member-icon">
            <span>
              ...
              />
              <img
                src="../../assets/image/my_vip_blkicon@3x.png"
                v-else
                alt=""
              />
            </span>
      ...
      >
        ...
        <div class="member-introduce-list">
          <div
            class="member-introduce-list-box"
      ...
      <div class="member-exclusive">
        ...
        <div class="member-goods-list">
          <div
            class="member-goods-list-item"
            v-for="(item, index) in vipGoods"
            :key="index"
            @click="musicDaile(item.url, true)"
            v-if="index < 3"
          >
      ...
      <div class="member-exclusive">
        ...
        <div class="member-goods-list">
          <div
            class="member-goods-list-item"
            v-for="(item, index) in xmlyContent"
            :key="index"
            @click="xmlay(item.id, item.name, 0)"
            v-if="index < 3"
          >
            <div class="list-item-img">
              <img :src="item.img" alt="" />
      ...
      <div class="member-exclusive">
        ...
        <div class="member-exclusive-list">
          <div
            class="member-exclusive-list-item"
            v-for="(item, index) in vipContent"
            :key="index"
      ...
      <div class="member-introduce" v-if="activeActivityList.length != 0">
        ...
        <div class="member-activity-list">
          <div
            class="member-activity-list-item"
      ...
      <div
        class="member-introduce member-help-content"
      ...
      try {
        ...
        if (type == 0) {
          data = {
            ...
            path:
              '/src/xxmPages/album/index?type=23&supplier=xxm&source=alilo&appkey=5a038226a57546a3b8beee9ec12c6ce6&id=' +
              id +
              '&title=' +
              name +
              '&huid=' +
